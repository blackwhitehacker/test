    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-10 animate-in fade-in slide-in-from-bottom-6 duration-1000">
        <div class="lg:col-span-2 space-y-8">
            <div class="card-enterprise p-8">
                <div class="flex items-center justify-between mb-8 border-b border-gray-100 pb-6 uppercase">
                    <h3 class="font-bold text-sm tracking-widest text-[#E11D48]">Danh sách tài sản đề xuất</h3>
                    <span class="text-[10px] font-bold text-gray-400">{{ count($request->items) }} mục</span>
                </div>

                <div class="overflow-x-auto">
                    <table class="table-premium">
                        <thead>
                            <tr class="text-[10px] font-bold uppercase text-gray-400 tracking-widest">
                                ...
                                <tr class="group">
                                    <td class="py-5">
                                        <div class="flex flex-col">
                                            <span class="text-sm font-bold text-gray-900 group-hover:text-[#E11D48] transition-colors uppercase tracking-tighter">{{ $item->name }}</span>
                                            <span class="text-[10px] text-gray-400 font-bold uppercase tracking-wider mt-1">{{ $item->specification }}</span>
                                            @if($item->asset)
                                                <span class="text-[9px] bg-gray-100 text-gray-600 px-2 py-0.5 rounded-full w-fit mt-2 font-bold italic">Mã: {{ $item->asset->code }}</span>
                                            @endif
                                        </div>
                                    </td>
                                    <td class="py-5 text-center">
                                        <span class="inline-flex items-center justify-center w-10 h-10 rounded-xl bg-gray-900 text-white font-bold text-sm shadow-lg shadow-gray-200">
                                            {{ $item->quantity }}
                                        </span>
                                    </td>
                                    <td class="py-5 text-right">
                                        <div class="text-sm font-bold text-gray-900 italic underline decoration-[#E11D48] decoration-2 underline-offset-4">
            ...
            <div class="card-enterprise p-8">
                <div class="flex items-center gap-4 mb-6 border-b border-gray-100 pb-6">
                    ...
                    <h3 class="font-bold text-sm uppercase tracking-widest text-[#E11D48]">Ghi chú & Giải trình lý do</h3>
                </div>
        ...
        <div class="space-y-8">
            <div class="card-enterprise p-8 bg-gray-900 text-white overflow-hidden relative">
                ...
                <h3 class="font-bold text-sm mb-8 border-b border-white/10 pb-6 text-[#E11D48] uppercase tracking-widest relative z-10">Thông tin tổng quát</h3>
                <div class="space-y-6 relative z-10">
                    <div class="flex flex-col">
                        <label class="text-[10px] font-bold uppercase text-gray-500 tracking-widest mb-1.5 italic">Phân hệ nghiệp vụ</label>
                        <p class="text-xs font-bold uppercase tracking-widest bg-white/5 p-3 rounded-xl border border-white/10">
                    ...
                    <div class="flex flex-col">
                        <label class="text-[10px] font-bold uppercase text-gray-500 tracking-widest mb-1.5 italic">Đối tượng hưởng quyền</label>
                    ...
                    <div class="flex justify-between items-end border-t border-white/5 pt-6 mt-4">
                        <div class="flex flex-col">
                            <label class="text-[10px] font-bold uppercase text-gray-500 mb-1 italic">Trạng thái phê duyệt</label>
                            @php
                                $statusConf = [
                            ...
                            @endphp
                            <span class="px-3 py-1.5 rounded-lg text-[9px] font-bold border {{ $st['class'] }} w-fit tracking-widest">
                                {{ $st['label'] }}
                            </span>
                        </div>
                    </div>
            ...
            @if($request->source_type == 'recall')
                <div class="card-enterprise p-8 bg-gray-50/50 border-gray-200 border-2">
                    <div class="flex items-center gap-4 mb-8 border-b border-gray-200 pb-6 uppercase">
                        ...
                        <h3 class="font-bold text-sm tracking-widest text-gray-900">Đánh giá kỹ thuật (Phòng kỹ thuật)</h3>
                    </div>
                    ...
                    @if(!$request->assessment_status && $request->status == 'pending')
                        <form action="{{ route('business_requests.assessment', $request) }}" method="POST" class="space-y-6">
                            ...
                            <div class="grid grid-cols-3 gap-4">
                                <label class="cursor-pointer group">
                                    ...
                                    <div class="p-4 rounded-2xl border-2 border-gray-100 bg-white peer-checked:border-green-600 peer-checked:bg-green-50 transition-all text-center">
                                        <p class="text-[10px] font-bold uppercase text-gray-400 peer-checked:text-green-600 tracking-widest mb-1">Tình trạng</p>
                                        <p class="text-sm font-bold text-gray-900">Sử dụng tốt</p>
                                    </div>
                                </label>
                                <label class="cursor-pointer group">
                                    ...
                                    <div class="p-4 rounded-2xl border-2 border-gray-100 bg-white peer-checked:border-amber-600 peer-checked:bg-amber-50 transition-all text-center">
                                        <p class="text-[10px] font-bold uppercase text-gray-400 peer-checked:text-amber-600 tracking-widest mb-1">Tình trạng</p>
                                        <p class="text-sm font-bold text-gray-900">Cần sửa chữa</p>
                                    </div>
                                </label>
                                <label class="cursor-pointer group">
                                    ...
                                    <div class="p-4 rounded-2xl border-2 border-gray-100 bg-white peer-checked:border-red-600 peer-checked:bg-red-50 transition-all text-center">
                                        <p class="text-[10px] font-bold uppercase text-gray-400 peer-checked:text-red-600 tracking-widest mb-1">Tình trạng</p>
                                        <p class="text-sm font-bold text-gray-900">Hỏng/Thanh lý</p>
                                    </div>
                                </label>
                            </div>
                            <div class="space-y-2">
                                <label class="text-[10px] font-bold uppercase text-gray-400 tracking-widest italic pl-1">Ghi chú đánh giá kỹ thuật</label>
                            ...
                            <button type="submit" class="w-full py-4 bg-gray-900 text-white text-[10px] font-bold uppercase tracking-widest rounded-xl hover:bg-[#E11D48] shadow-lg shadow-gray-200 transition-all italic">
                    ...
                    @else
                        <div class="space-y-4">
                            ...
                            <div class="p-6 rounded-2xl border {{ $ast['class'] }} flex items-center justify-between">
                                <div>
                                    <p class="text-[10px] font-bold uppercase tracking-widest opacity-60 mb-1">Kết quả đánh giá</p>
                                    <p class="text-sm font-bold">{{ $ast['label'] }}</p>
                                </div>
                            ...
                            @if($request->status == 'pending')
                                <div class="flex gap-3 pt-4">
                                    <form action="{{ route('business_requests.approve', $request) }}" method="POST" class="flex-1">
                                        @csrf
                                        <button type="submit" class="w-full py-4 bg-green-600 text-white text-[10px] font-bold uppercase tracking-widest rounded-xl hover:bg-green-700 shadow-lg shadow-green-200 italic">
                                            Duyệt thu hồi & Tạo BBHT
                                        </button>
                                    </form>
                                    <form action="{{ route('business_requests.reject', $request) }}" method="POST" class="flex-shrink-0">
                                        @csrf
                                        <button type="submit" class="px-6 py-4 bg-red-50 text-red-700 text-[10px] font-bold uppercase tracking-widest rounded-xl hover:bg-red-100 border border-red-200">
                                            Từ chối
                                        </button>
                                    </form>
                                </div>
                ...
                <div class="card-enterprise bg-gray-50/50 border-gray-200 border-2 overflow-hidden">
                    <div class="p-8 border-b border-gray-200 flex items-center justify-between uppercase">
                        <div class="flex items-center gap-4">
                            ...
                            <h3 class="font-bold text-sm tracking-widest text-gray-900">Quản lý sửa chữa tài sản</h3>
                        </div>
                        @if($request->repair_status)
                            <span class="px-4 py-1 bg-gray-900 text-white text-[9px] font-bold rounded-full uppercase tracking-widest">
                                {{ 
                    ...
                    <div class="p-8">
                        @if($request->status == 'approved' || ($request->status == 'completed' && $request->source_type == 'repair'))
                            <form action="{{ route('business_requests.repair_update', $request) }}" method="POST" class="space-y-6">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div class="space-y-2">
                                        <label class="text-[10px] font-bold text-gray-500 uppercase tracking-widest">Trạng thái sửa chữa</label>
                                    ...
                                    <div class="space-y-2">
                                        <label class="text-[10px] font-bold text-gray-500 uppercase tracking-widest">Chi phí sửa chữa (VNĐ)</label>
                                ...
                                <div class="space-y-2">
                                    <label class="text-[10px] font-bold text-gray-500 uppercase tracking-widest">Ghi chú sửa chữa (Chi tiết linh kiện, lỗi...)</label>
                                ...
                                <div class="flex justify-end pt-4 gap-3">
                                    @if($request->repair_status == 'unfixable')
                                        <a href="{{ route('business_requests.export_liquidation', $request) }}" class="px-6 py-4 bg-gray-900 text-white text-[10px] font-bold uppercase tracking-widest rounded-xl hover:bg-[#E11D48] transition-all flex items-center gap-3 shadow-lg shadow-gray-200">
                                            Xuất biên bản thanh lý
                                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 10v6m0 0l-3-3m3 3l3-3m2 8H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path></svg>
                                        </a>
                                    @endif
                                    <button type="submit" class="px-8 py-4 bg-gray-900 text-white text-[10px] font-bold uppercase tracking-widest rounded-xl hover:bg-[#E11D48] shadow-lg shadow-gray-200 transition-all flex items-center gap-3">
                            ...
                            @if($request->repair_status == 'unfixable')
                                <div class="mt-8 p-6 bg-red-50 border-2 border-red-100 rounded-2xl flex items-center gap-6 animate-in fade-in zoom-in duration-500">
                                    ...
                                    <div>
                                        <p class="text-[10px] font-bold text-red-600 uppercase tracking-widest italic">Cảnh báo hệ thống</p>
                        ...
                        @else
                            <div class="text-center py-12">
                                <p class="text-[10px] font-bold text-gray-400 uppercase tracking-widest italic">Đang chờ quản trị viên duyệt yêu cầu sửa chữa...</p>
                            </div>
                        @endif
                    </div>
                </div>
                ...
                <div class="card-enterprise p-8 bg-gray-50/50 border-gray-200 border-2" x-data="{ compliance: null, loading: false }">
                    <div class="flex items-center justify-between mb-8 border-b border-gray-200 pb-6 uppercase">
                        <div class="flex items-center gap-4">
                            ...
                            <h3 class="font-bold text-sm tracking-widest text-gray-900">Đánh giá định mức cấp phát</h3>
                        </div>
                        @if($request->status == 'pending')
                            <button @click="loading = true; fetch('{{ route('business_requests.check_compliance', $request) }}').then(r => r.json()).then(data => { compliance = data; loading = false; })" 
                                    class="px-4 py-2 bg-gray-900 text-white text-[10px] font-bold uppercase tracking-widest rounded-xl hover:bg-[#E11D48] transition-all flex items-center gap-2">
                    ...
                    <div x-show="compliance" class="space-y-4 animate-in fade-in slide-in-from-top-2">
                        <template x-for="item in compliance.compliance" :key="item.group">
                            <div class="p-4 bg-white rounded-xl border flex justify-between items-center shadow-sm" :class="item.exceeds ? 'border-red-200 bg-red-50/30' : 'border-green-100 bg-green-50/30'">
                                <div>
                                    <p class="text-[10px] font-bold uppercase tracking-wider mb-1 italic" :class="item.exceeds ? 'text-red-500' : 'text-green-600'" x-text="item.group"></p>
                                ...
                                <div>
                                    <span x-show="item.exceeds" class="px-3 py-1 bg-red-600 text-white text-[9px] font-bold rounded-lg uppercase tracking-widest">Vi phạm định mức</span>
                                    <span x-show="!item.exceeds" class="px-3 py-1 bg-green-600 text-white text-[9px] font-bold rounded-lg uppercase tracking-widest italic">Trong định mức</span>
                                </div>
                            </div>
                        </template>
                        ...
                        <div x-show="compliance && '{{ $request->status }}' == 'pending'" class="mt-8 space-y-3">
                            <div class="p-4 bg-blue-50/50 rounded-xl border border-blue-100 mb-4 animate-pulse">
                                <p class="text-[10px] font-bold text-blue-600 uppercase tracking-widest italic">Hành động quản trị</p>
                            ...
                            <div x-show="compliance.is_exceeded" class="mt-4 pt-4 border-t border-gray-200 flex gap-3">
                                <form action="{{ route('business_requests.escalate', $request) }}" method="POST" class="flex-1">
                                    @csrf
                                    <button type="submit" class="w-full py-3 bg-amber-600 text-white text-[10px] font-bold uppercase tracking-widest rounded-xl hover:bg-amber-700 shadow-lg shadow-amber-200 italic">
                                        Gửi Giám đốc (Ngoài định mức)
                                    </button>
                                </form>
                                <a href="{{ route('purchase_requisitions.create', ['source_request' => $request->code]) }}" 
                                   class="flex-1 py-3 bg-gray-900 text-white text-[10px] font-bold uppercase tracking-widest rounded-xl hover:bg-gray-800 text-center shadow-lg shadow-gray-200">
                                    Đề xuất mua sắm
                                </a>
                            </div>
                        </div>
                ...
                <div class="card-enterprise bg-gray-50/50 border-gray-200 border-2 overflow-hidden mb-8">
                    <div class="p-8 border-b border-gray-200 flex items-center justify-between uppercase">
                        <div class="flex items-center gap-4">
                            ...
                            <h3 class="font-bold text-sm tracking-widest text-gray-900">Quản lý thanh lý tài sản</h3>
                        </div>
                    </div>
                    ...
                    <div class="p-8">
                        ...
                        @elseif($request->status == 'approved' || $request->status == 'completed')
                            <form action="{{ route('business_requests.liquidation_update', $request) }}" method="POST" class="space-y-6">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div class="space-y-2">
                                        <label class="text-[10px] font-bold text-gray-500 uppercase tracking-widest italic">Giá trị thu hồi (VNĐ)</label>
                                    ...
                                    <div class="space-y-2">
                                        <label class="text-[10px] font-bold text-gray-500 uppercase tracking-widest italic">Liên kết biên bản</label>
                                        <div class="flex items-center gap-2">
                                            <a href="{{ route('business_requests.export_liquidation', $request) }}" class="flex-1 py-3.5 bg-gray-900 text-white text-[10px] font-bold uppercase tracking-widest rounded-xl hover:bg-[#E11D48] text-center shadow-lg transition-all">
                                ...
                                <div class="space-y-2">
                                    <label class="text-[10px] font-bold text-gray-500 uppercase tracking-widest italic">Ghi chú thanh lý</label>
                                ...
                                @if($request->status == 'approved')
                                    <div class="flex justify-end pt-4">
                                        <button type="submit" class="px-8 py-4 bg-gray-900 text-white text-[10px] font-bold uppercase tracking-widest rounded-xl hover:bg-green-600 shadow-lg shadow-gray-200 transition-all flex items-center gap-3 italic">
            ...
            @if($request->status == 'approved' && $request->handoverRecord)
                <div class="card-enterprise p-8 bg-blue-50/50 border-blue-100 border-2">
                    <div class="flex items-center gap-4 mb-6 border-b border-blue-100 pb-6">
                        ...
                        <h3 class="font-bold text-sm uppercase tracking-widest text-blue-700">
                    ...
                    <div class="space-y-4">
                        <div class="p-4 bg-white rounded-xl border border-blue-100 flex justify-between items-center shadow-sm">
                            <div>
                                <p class="text-[10px] font-bold uppercase text-blue-400 tracking-wider mb-1 italic">Mã số biên bản</p>
                                <p class="text-xs font-bold text-blue-900 uppercase tracking-tighter italic underline decoration-blue-200">{{ $request->handoverRecord->code }}</p>
                            </div>
                            <div class="flex gap-2">
                                <a href="{{ route('handover_records.show', $request->handoverRecord) }}" class="px-5 py-2.5 bg-blue-600 text-white text-[10px] font-bold uppercase tracking-widest rounded-xl hover:bg-blue-700 transition-all shadow-md shadow-blue-200">
                                    Chi tiết & Hoàn thiện
                                </a>
                            </div>
                        </div>
            ...
            <div class="card-enterprise p-8">
                <h3 class="font-bold text-sm mb-8 border-b border-gray-100 pb-6 text-[#E11D48] uppercase tracking-widest">Nhật ký hệ thống</h3>
                <div class="relative">
                    ...
                    <div class="space-y-8 relative">
                            ...
                            <div class="flex gap-6 pl-1 group">
                                ...
                                <div class="pb-1 translate-y-[-2px]">
                                    <div class="flex items-center gap-2 mb-1">
                                        <span class="text-[11px] font-bold text-gray-900 group-hover:text-[#E11D48] uppercase">{{ $log->user->name ?? 'SYSTEM' }}</span>
                        ...
                        @empty
                            <div class="flex flex-col items-center py-6 text-center">
                                ...
                                <p class="text-[10px] text-gray-400 font-bold uppercase tracking-widest">Chưa có nhật ký</p>
                            </div>
                        @endforelse
                    </div>
                </div>
