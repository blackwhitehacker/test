<x-app-layout>
    ...
    <div class="max-w-5xl mx-auto">
        <div class="card-premium">
            <form action="{{ route('contracts.store') }}" method="POST" enctype="multipart/form-data" class="p-6">
                @csrf
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <input type="text" name="contract_number" required value="{{ old('contract_number') }}"
                                   class="enterprise-input" placeholder="Ví dụ: 123/2024/HĐMS">
                        </div>
                        ...
                        <div x-data="{ 
                            ...
                            selectPartner(p) {
                                ...
                                this.partners = [];
                                // Dispatch event or fill other hidden fields if needed
                                // For now, the user wants it to feel like a 'fill-in' box
                            }
                        }" class="relative">
                        ...
                        <div>
                            ...
                            <select name="requisition_id" class="enterprise-input">
                                ...
                                @foreach($requisitions as $requisition)
                                    <option value="{{ $requisition->id }}" {{ old('requisition_id') == $requisition->id ? 'selected' : '' }}>
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="date" name="signed_date" value="{{ old('signed_date') }}" class="enterprise-input">
                            </div>
                            <div>
                                <label class="enterprise-label">Ngày hết hạn</label>
                                <input type="date" name="expiration_date" value="{{ old('expiration_date') }}" class="enterprise-input">
                            </div>
                        </div>
                        <div>
                            <label class="enterprise-label">Thời hạn bảo hành (Tháng)</label>
                            <input type="number" name="warranty_months" min="0" value="{{ old('warranty_months', 0) }}"
                        ...
                        <div>
                            <div class="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-gray-300 border-dashed rounded-md hover:border-red-400 transition-colors bg-gray-50">
                                <div class="space-y-1 text-center">
                                    ...
                                    <p class="text-xs text-gray-400">PDF, Ảnh, Docx (Tối đa 10MB)</p>
                                </div>
                            </div>
                        </div>
                    </div>
